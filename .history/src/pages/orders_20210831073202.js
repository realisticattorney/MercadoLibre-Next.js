    ...
    <div>
      ...
      <main className="max-w-screen-lg flex">
        <div className="flex-col bg-gray-100">
          <div className="py-10 pl-4 pr-5 border-l-4 border-transparent">
            <HeartIcon className="h-5" />
          </div>
          <div className="py-2 pl-4 pr-5 transition ease-in-out cursor-pointer border-l-4 border-transparent hover:border-blue-600">
            <HeartIcon className="h-5" />
          </div>
        </div>
