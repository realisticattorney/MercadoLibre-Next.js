...
const Practice = ({ products }) => {
  ...
  return (
    <div className="flex flex-col bg-gray-200">
      ...
      <main className="max-w-screen-2xl mx-auto my-2">
        <p className="py-5">
         ...
         <div className="flex">
         <div className="flex flex-col min-w-[400px] mx-10 px-10">
<h5>Descuentazos electronicaElectrodomésticos y Aires Ac.</h5>
<h5 className="text-2xl">Descuentazos: Electrodomésticos y Aires Ac.</h5>
