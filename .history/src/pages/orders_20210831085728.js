...
const Orders = ({ orders }) => {
  ...
  return (
    <div className=" bg-gray-200 min-h-screen h-full overflow-hidden">
      <Header />
      <main className="relative max-w-screen-lg flex mx-auto overscroll-y-none">
        <div className="flex-col bg-gray-100 fixed left-0 h-full transform -translate-y-full">
