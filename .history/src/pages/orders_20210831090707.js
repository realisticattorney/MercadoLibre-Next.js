    ...
    <div className=" bg-gray-200 min-h-screen h-full">
      ...
      <main className="relative flex mx-auto">
        <div className="flex-col bg-gray-100 absolute left-0 h-full transform">
          <div className="py-10 pl-4 pr-5 border-l-4 border-transparent text-blue-600 md:text-gray-500 flex space-x-2">
          
            <MenuIcon className="h-6" />
            <h4 className="hidden md:font-semibold" >My account</h4>
          </div>
