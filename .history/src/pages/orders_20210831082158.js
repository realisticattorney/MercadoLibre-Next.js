    ...
    <div>
      ...
      <main className="max-w-screen-lg flex">
        <div className="flex-col bg-gray-100">
          ...
          <div className="py-4 pl-4 pr-5 transition ease-in-out cursor-pointer border-l-4 border-transparent hover:border-blue-500 text-blue-500">
        ...
        {/* right-side */}
        <div className="bg-gray-200 flex-grow p-10">
