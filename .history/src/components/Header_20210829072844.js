        ...
        <div className="flex lg:col-span-1 lg:row-start-2 lg:col-start-3 lg:row-span-1  items-center justify-end">
          <div className="hidden lg:flex items-center mr-20 space-x-3">
            <Menu as="div" className="relative">
              ...
              <Menu.Items className="origin-top absolute -right-10 mt-3 w-60 rounded-l-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50 py-3">
                <Menu.Item className="">
                  <>
                    <a
                      href="#"
                      className="group flex py-3 items-center text-sm text-gray-700 font-medium hover:bg-blue-500 hover:text-gray-700 pl-8"
                    >
                      Motors
                    </a>
                    <a
