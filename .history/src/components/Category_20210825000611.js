...
const Category = ({ category }) => {
  ...
  return id === 3 ||
    ...
    id === 13 ||
    id === 16 ? (
    <div className="col-span-full lg:col-span-2 relative flex flex-col m-2 bg-white z-30 p-5 hover:shadow-xl shadow-lg rounded-lg transform transition-shadow h-48">
