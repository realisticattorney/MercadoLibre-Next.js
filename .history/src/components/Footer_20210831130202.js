const Footer = () => {
   return (
      ...
      <div className="flex-col space-y-1">
         <ul className="flex space-x-5 text-xs text-gray-700">
            <li>Work with us</li>
         ...
         <h3 className="text-gray-700 text-sm font-bold"><span className="text-gray-500 font-medium">built by</span> German Aquila</h3>
      </div>
