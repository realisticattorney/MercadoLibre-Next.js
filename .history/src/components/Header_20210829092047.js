            ...
            <Menu.Items className="origin-top absolute -right-10 mt-3 w-60 rounded-l-md shadow-lg bg-mercadolibre-gray ring-1 ring-black ring-opacity-5 focus:outline-none z-50 py-3">
              <Menu.Item className="">
                <>
                  ...
                  <a
                    href="#"
                    className="group flex py-3 pl-8 pr-5 items-center text-sm text-white font-medium hover:bg-blue-500 hover:text-white"
                  >
                    Real State
                  </a>
                  <Menu as="div" className="relative w-[700px]">
                    <Menu.Button
                      href="#"
                      className="group flex py-3 pl-8 w-60  items-center text-sm text-white font-medium hover:bg-blue-500 hover:text-white focus:outline-none justify-between"
                    >
                      Electronics
