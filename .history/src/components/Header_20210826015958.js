...
const Header = () => {
  ...
  return (
    <header className="lg:grid lg:grid-flow-col lg:grid-rows-2 bg-amazon_blue items">
      ...
      <div className="flex items-center justify-between space-x-3 py-2 pl-2 bg-amazon_blue text-sm lg:contents">
        ...
        <div className="lg:col-span-1 lg:row-start-2 lg:col-start-2 lg:row-span-1 hidden lg:flex space-x-2">
