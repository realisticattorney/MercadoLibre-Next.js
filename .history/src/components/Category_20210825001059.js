...
const Category = ({ category }) => {
  ...
  return id === 3 ||
    ...
    <div className="col-span-full lg:col-span-2 relative flex flex-col m-2 bg-white z-30 p-5 hover:shadow-xl shadow-lg rounded-sm md:rounded-md transform transition-shadow h-40">
        <Image src={src} layout="fill" objectFit="cover" className="rounded-sm md:rounded-md" />
