                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p className="text">Smarthphones</p>
                              <p className="text">Accessories for smartphones</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Cameras & Accessories</p>
                              <p className="text">Digital Cameras</p>
                              <p className="text">Accessories for cameras</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Videogame Consoles</p>
                              <p className="text">Videogames</p>
                              <p className="text">For PS5</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Computers</p>
                              <p className="text">Components</p>
                              <p className="text">Prints</p>
                              <p className="text">Tablets & Pads</p>
                              <p className="text">PC</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Audio & Video</p>
                              <p className="text">Audio</p>
                              <p className="text">Accessories for Audio & Video</p>
                              <p className="text">Drones & Accessories</p>
                            </div>
                            <div>
