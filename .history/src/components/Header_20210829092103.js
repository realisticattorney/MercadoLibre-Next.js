              ...
              <Menu.Item className="">
                <>
                  ...
                  <Menu as="div" className="relative w-[700px]">
                    <Menu.Button
                      href="#"
                      className="group flex py-3 pl-8 pr-3 w-60  items-center text-sm text-white font-medium hover:bg-blue-500 hover:text-white focus:outline-none justify-between"
                    >
                      Electronics
