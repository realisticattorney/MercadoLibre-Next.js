                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p className="hover:text-blue-600">Smarthphones</p>
                              <p className="hover:text-blue-600">Accessories for smartphones</p>
                            </div>
                            <div>
                              <p className="font-medium ">
                                Cameras & Accessories
                              </p>
                              <p className="hover:text-blue-600">Digital Cameras</p>
                              <p className="hover:text-blue-600">Accessories for cameras</p>
                            </div>
                            <div>
                              <p className="font-medium ">Videogame Consoles</p>
                              <p className="hover:text-blue-600">Videogames</p>
                              <p className="hover:text-blue-600">For PS5</p>
                            </div>
                            <div>
                              <p className="font-medium ">Computers</p>
                              <p className="hover:text-blue-600">Components</p>
                              <p className="hover:text-blue-600">Prints</p>
                              <p className="hover:text-blue-600">Tablets & Pads</p>
                              <p className="hover:text-blue-600">PC</p>
                            </div>
                            <div>
                              <p className="font-medium ">Audio & Video</p>
                              <p className="hover:text-blue-600">Audio</p>
                              <p className="hover:text-blue-600">Accessories for Audio & Video</p>
                              <p className="hover:text-blue-600">Drones & Accessories</p>
                            </div>
                            <div>
