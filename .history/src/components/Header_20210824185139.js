    ...
    <header>
      <div className="px-1 flex items-center bg-amazon_blue flex-grow">
        ...
        <div className="hidden sm:flex items-center h-7 rounded-sm flex-grow bg-white cursor-pointer ">
          <SearchIcon className="h-6 p-1 pl-2 text-gray-400" />
          <input
            className="p-2 h-full w-6 flex-grow flex-shrink rounded-l-md focus:outline-none px-4 text-sm text-gray-300"
            type="text"
