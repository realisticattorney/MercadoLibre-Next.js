                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p className="">Smarthphones</p>
                              <p className="">Accessories for smartphones</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Cameras & Accessories</p>
                              <p className="">Digital Cameras</p>
                              <p className="">Accessories for cameras</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Videogame Consoles</p>
                              <p className="">Videogames</p>
                              <p className="">For PS5</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Computers</p>
                              <p className="">Components</p>
                              <p className="">Prints</p>
                              <p className="">Tablets & Pads</p>
                              <p className="">PC</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Audio & Video</p>
                              <p className="">Audio</p>
                              <p className="">Accessories for Audio & Video</p>
                              <p className="">Drones & Accessories</p>
                            </div>
                            <div>
