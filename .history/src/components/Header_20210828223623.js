      ...
      {isOpen && (
        <div className="origin-top absolute right-0 -mt-10 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50">
          ...
          <div className="p-2 space-y-6">
            <a
              href="#"
              className="group flex items-center px-4 pt-4 text-sm text-gray-900 font-medium pl-1 hover:bg-indigo-500 hover:text-white"
            >
              <HomeIcon
            ...
            <a
              href="#"
              className="group flex items-center px-4 text-sm text-gray-900 font-medium pl-1 hover:bg-indigo-500 hover:text-white"
            >
              <BellIcon
                className="mr-3 h-5 w-5 text-gray-400 group-hover:text-white"
                aria-hidden="true"
