...
const Header = () => {
  ...
  return (
    <header className="lg:grid lg:grid-flow-col lg:grid-rows-2 bg-amazon_blue items-center">
      ...
      <div className="hidden lg:flex lg:col-span-1 lg:row-start-1 lg:col-start-3 lg:row-span-1">
    <h4 className="text-amazon_blue-light text-lg text-center">Up to 4 months of Disney+ free</h4>
      </div>
    </header>
  );
};
