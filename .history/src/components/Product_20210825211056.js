...
const Product = ({ product }) => {
  const { id, title, price, thumbnail, condition, eshop } = product;
  ...
  return (
    <div className="relative flex flex-col m-2 bg-white z-30 p-5 hover:shadow-md">
      ...
      <p className="text-xs my-2 line-clamp-2">{title}
      <span className="text-gray-500 text-xs my-2 line-clamp-2">sold by {eshop.nick_name}</span>
