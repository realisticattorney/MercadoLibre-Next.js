                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p className="hover">Smarthphones</p>
                              <p className="hover">Accessories for smartphones</p>
                            </div>
                            <div>
                              <p className="font-medium ">
                                Cameras & Accessories
                              </p>
                              <p className="hover">Digital Cameras</p>
                              <p className="hover">Accessories for cameras</p>
                            </div>
                            <div>
                              <p className="font-medium ">Videogame Consoles</p>
                              <p className="hover">Videogames</p>
                              <p className="hover">For PS5</p>
                            </div>
                            <div>
                              <p className="font-medium ">Computers</p>
                              <p className="hover">Components</p>
                              <p className="hover">Prints</p>
                              <p className="hover">Tablets & Pads</p>
                              <p className="hover">PC</p>
                            </div>
                            <div>
                              <p className="font-medium ">Audio & Video</p>
                              <p className="hover">Audio</p>
                              <p className="hover">Accessories for Audio & Video</p>
                              <p className="hover">Drones & Accessories</p>
                            </div>
                            <div>
