                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p className="hover:text-blue-600 cursor-pointer">Smarthphones</p>
                              <p className="hover:text-blue-600 cursor-pointer">Accessories for smartphones</p>
                            </div>
                            <div>
                              <p className="font-medium hover:text-blue-600 cursor-pointer">
                                Cameras & Accessories
                              </p>
                              <p className="hover:text-blue-600 cursor-pointer">Digital Cameras</p>
                              <p className="hover:text-blue-600 cursor-pointer">Accessories for cameras</p>
                            </div>
                            <div>
                              <p className="font-medium hover:text-blue-600 cursor-pointer">Videogame Consoles</p>
                              <p className="hover:text-blue-600 cursor-pointer">Videogames</p>
                              <p className="hover:text-blue-600 cursor-pointer">For PS5</p>
                            </div>
                            <div>
                              <p className="font-medium hover:text-blue-600 cursor-pointer">Computers</p>
                              <p className="hover:text-blue-600 cursor-pointer">Components</p>
                              <p className="hover:text-blue-600 cursor-pointer">Prints</p>
                              <p className="hover:text-blue-600 cursor-pointer">Tablets & Pads</p>
                              <p className="hover:text-blue-600 cursor-pointer">PC</p>
                            </div>
                            <div>
                              <p className="font-medium hover:text-blue-600 cursor-pointer">Audio & Video</p>
                              <p className="hover:text-blue-600 cursor-pointer">Audio</p>
                              <p className="hover:text-blue-600 cursor-pointer">Accessories for Audio & Video</p>
                              <p className="hover:text-blue-600 cursor-pointer">Drones & Accessories</p>
                            </div>
                            <div>
                              <p className="font-medium hover:text-blue-600 cursor-pointer">TVs</p>
                            </div>
                          </div>
                        </div>
                      </Menu.Item>
