...
const Header = () => {
  ...
  const = ["Start", "Notifications", "My Orders", "Favorites", "My account", "Deals", "Movies & TV Shows", "History", "Sell", "Supermarket", "Fashion", "Official Stores", "Categories", "Help", Buy and sell using our app! ]
