                        ...
                        <div className="flex flex-col w-full">
                          ...
                          <div className="grid grid-cols-3 grid-rows-2 mt-5">
                            <div>
                              ...
                              <p clas>Smarthphones</p>
                              <p clas>Accessories for smartphones</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Cameras & Accessories</p>
                              <p clas>Digital Cameras</p>
                              <p clas>Accessories for cameras</p>
                            </div>
                            <div>
                            ...
                            <p className="font-medium text-base">Computers</p>
                              <p clas>Components</p>
                              <p clas>Prints</p>
                              <p clas>Tablets & Pads</p>
                              <p clas>PC</p>
                            </div>
                            <div>
                            <p className="font-medium text-base">Audio & Video</p>
                              <p clas>Audio</p>
                              <p clas>Accessories for Audio & Video</p>
                              <p clas>Drones & Accessories</p>
                            </div>
                            <div>
