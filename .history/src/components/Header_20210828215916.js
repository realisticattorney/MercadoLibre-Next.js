      ...
      <div className="px-2 flex items-center bg-mercadolibre flex-grow py-1 border-b border-gray-400 border-opacity-30 lg:contents ">
        ...
        <div className="text-mercadolibre-blue flex items-center text-xs whitespace-nowrap lg:col-span-1 lg:row-start-2 lg:col-start-3 lg:row-span-1 lg:flex-row-reverse">
          <div>
            ...
            >
              <XIcon
                className="h-6 scale-100 text-mercadolibre-blue lg:hidden heroicon-sw-0.8 transition-transform duration-500 transform active:scale-0"
                aria-hidden="true"
              />
              <MenuIcon
                className="h-6 scale-0 text-mercadolibre-blue lg:hidden heroicon-sw-0.8  transition-transform duration-500 transform active:scale-100"
                aria-hidden="true"
              />
            </button>
          </div>
