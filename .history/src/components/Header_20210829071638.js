                  ...
                  <Menu.Items className="origin-top absolute right-0 mt-3 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50">
                      ...
                      <div className="flex-col group flex justify-center px-4 py-2 text-sm ">
                        {session ? (
                          <>
                            ...
                            <a
                              href="#"
                              className="group flex items-center text-base  text-gray-900 heroicon-sw-1.2 hover:bg- hover:text-white font-semibold"
                            >
                              Level 5 - Advanced {'>'}
                            </a>{' '}
                          </>
                    ...
                    <div className="p-6 space-y-6">
                      <Menu.Item>
                        <a
                          href="#"
                          className="group flex items-center text-sm text-gray-900 font-medium hover:bg- hover:text-white"
                        >
                          <HomeIcon
