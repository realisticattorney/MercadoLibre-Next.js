        ...
        <div className="origin-top absolute right-0 -mt-10 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50">
          <div className="flex px-4 py-2 items-center">
            ...
            <div className="flex-col group flex justify-center px-4 py-2 text-sm ">
              ...
              <a
                href="#"
                className="group flex items-center text-base  text-gray-800 heroicon-sw-1.2 hover:bg-indigo-500 hover:text-white font-semibold"
              >
                Level 5 - Advanced {'>'}
              </a>
            </div>
          ...
          <div className="p-2 space-y-6">
            ...
            >
              <HomeIcon
                className="mr-3 h-6 w-6 text-gray-800 heroicon-sw-1.2  group-hover:text-white"
                aria-hidden="true"
              />
              Start
            </a>
