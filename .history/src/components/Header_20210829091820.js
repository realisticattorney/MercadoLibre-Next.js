              ...
              <Menu.Item className="">
                <>
                  ...
                  <Menu as="div" className="relative w-[700px]">
                    <Menu.Button
                      href="#"
                      className="group flex py-3 pl-8 w-60  items-center text-sm text-white font-medium hover:bg-blue-500 hover:text-white focus:outline-none items-center"
                    >
                      Electronics
                      <ChevronRightIcon className="h-5 text-gray-500 text-opacity-50 no-underline" />
                    </Menu.Button>
