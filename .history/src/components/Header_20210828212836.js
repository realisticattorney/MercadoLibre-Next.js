        ...
        <div className="origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none">
          ...
          <div className="py-1">
            <a href="#" className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-500 hover:text-white">
              <PencilAltIcon className="mr-3 h-5 w-5 text-gray-400 group-hover:text-white" aria-hidden="true" />Edit
            </a>
            <a href="#" className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-500 hover:text-white">
              <PencilAltIcon className="mr-3 h-5 w-5 text-gray-400 group-hover:text-white" aria-hidden="true" />Duplicate
            </a>
          </div>
          </div>
