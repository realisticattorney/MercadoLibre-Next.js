      ...
      <div className="flex items-center justify-between space-x-3 py-2 pl-2 bg-mercadolibre text-sm lg:contents">
        ...
        <div className="lg:col-span-1 lg:row-start-2 lg:col-start-2 lg:row-span-1 hidden lg:flex space-x-4 text-gray-600 font-light">
          <Menu as="div" className="relative">
            ...
            <Menu.Items className="origin-top absolute right-0 mt-3 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50 py-3 px-20 ">
              <Menu.Item className="">
                <>
                  <a
                    href="#"
                    className="group flex py-3 items-center text-sm text-gray-900 font-medium hover:bg-indigo-500 hover:text-white whitespace-nowrap"
                  >
                    <OfficeBuildingIcon
                      className="mr-3 h-6 w-6 text-gray-900 heroicon-sw-1.2  group-hover:text-white"
                      aria-hidden="true"
