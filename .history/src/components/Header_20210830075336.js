                ...
                {open && (
                  <Menu.Items className="origin-top absolute right-0 mt-3 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50">
                    ...
                    <div className="p-6 space-y-6">
                          {'[Start, Notifications My Orders, Favorites, My account, Deals, Movies & TV Shows, History, Sell, Supermarket, Fashion, Official Stores, Categories, Sell, Buy and sell using our app! ]'}
                      <Menu.Item>
                        <a
                          href="#"
