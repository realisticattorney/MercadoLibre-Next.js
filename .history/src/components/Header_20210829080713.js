              ...
              <Menu.Items className="origin-top absolute -right-10 mt-2.5 w-72 rounded-b-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50 py-3 divide-y">
                ...
                <Menu.Item className="">
                  <div>
                    <a
                      href="#"
                      className="group flex py-0 items-center text-sm text-gray-700 font-medium hover:bg-blue-500 hover:text-white pl-8"
                    >
                      Motors
                    </a>
                    <a
                      href="#"
                      className="group flex py-0 pl-8  items-center text-sm text-gray-700 font-medium hover:bg-blue-500 hover:text-white"
                    >
                      Real State
                    </a>
                  </div>
