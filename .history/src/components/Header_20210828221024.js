  ...
  return (
    <header className="lg:grid lg:grid-flow-col lg:grid-rows-2 bg-mercadolibre items-center lg:pl-3 lg:pt-1">
      ...
      {isOpen && (
        ...
        <div className="flex-col group flex items-center px-4 py-2 text-sm ">
          <p className="text-gray-600 text-xs">Hi {(session.user.name).split(" ")[0]}</p>
            <a
              href="#"
              className="group flex justify-center text-sm  text-gray-700 hover:bg-indigo-500 hover:text-white"
            >
              <PencilAltIcon
