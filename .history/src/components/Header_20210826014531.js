...
const Header = () => {
  ...
  return (
    <header className="lg:grid lg:grid-cols-3 lg:grid-rows-2">
      <div className="px-2 flex items-center bg-amazon_blue flex-grow py-1 border-b border-gray-400 border-opacity-30 inline-grid">
        {/*Left - Logo */}
        <div
          className="flex items-center cursor-pointer col-span-1 row-start-1 col-start-1 row-span-1"
          onClick={() => router.push('/')}
        >
          <Image
            src="/images/logo.jpg"
